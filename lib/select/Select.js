  ...
  render(h){
    ...
    if(!this.filterList.length){
      listChildren.push(h('div', {
        ...
        h('span', {class:'owlfont owl-kongshuju'}), 
    ...
    if(this.multiple && this._value && this._value.length) { // 如果选了多选
      multipleDom = h('div', { class: 'owl-multiple-box' }, [
        h('div', {class: 'owl-multiple-item'}, [
          h('span', this.currentLabel[0]),
          h('span', {class: 'owlfont owl-cheng close', on: {click: this.onRemoveFirst}})
        ]),
